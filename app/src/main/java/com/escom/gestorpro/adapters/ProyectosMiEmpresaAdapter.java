...
import com.escom.gestorpro.activities.MiEmpresaDetailActivity;
...
public class ProyectosMiEmpresaAdapter extends FirestoreRecyclerAdapter<Proyecto, ProyectosMiEmpresaAdapter.ViewHolder> {
    Context context;
    ProyectoProvider mProyectoProvider;
    TareaProvider mTareaProvider;
    int total_tareas = 0;

    public ProyectosMiEmpresaAdapter(FirestoreRecyclerOptions<Proyecto> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, int position, @NonNull final Proyecto proyecto) {
        ...
        holder.viewHolder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, MiEmpresaDetailActivity.class);
